...
<?php $form = ActiveForm::begin(['id'=>'contentList','options' => ['method'=>'post','class'=>'form-horizontal']]);?>
	<div class="portlet box grey">
		<div class="portlet-title">
			<div class="caption"><i class="fa fa-reorder"></i>Gallary List</div>
			<div class="actions">
				...
				<a href="<?= Url::toRoute('gallary/edit')?>" class="btn green"><i class="fa fa-plus"></i> New Gallary</a>
					...
					<?php foreach($contentList as $i=>$model){?>
						<tr>
							...
							<td title="<?= $model['title']?>">
								<a class="" href="<?= Url::toRoute(['gallary/edit','id'=>$model['id']])?>">
							...
							<td align="center">
								<a class="btn btn-sm btn-warning" href="<?= Url::toRoute(['gallary/edit','id'=>$model['id']])?>"><i class="fa fa-edit"></i> Edit</a>
							</td>
						</tr>
					<?php }?>
					</tbody>
